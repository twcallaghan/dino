...
while (1):
    ...
    for pic, contour in enumerate(contours):
        ...
        if (area > 12500): #TODO: play with the area here to get a more accurate value
            contourbool = True
...
pygame.init()
fpscounter = 0
fps = 120  # this essentially decides how fast everything will be updating on the screen, need to test on a 60Hz screen as my screen with 144fps is a lot faster than it is with 60
...
while(startingloop == True):
    ...
    for pic, contour in enumerate(contours):
        ...
        if (area > 12500):  # TODO: play with the area here to get a more accurate value
            ...
            heights.append(y)
            # print y
        if len(heights) > 150 and endtime-starttime > 5:
            print 'I NOW HAVE ENOUGH POINTS: GO!'
            a = 0
            totalheight = 0
            avgheight = 0

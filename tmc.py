...
class Object(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.frame = 0
        self.images = []
        img = pygame.image.load(os.path.join(imageinput)).convert()
        #img.convert_alpha()
    ...
    def jump(self, y):
        self.movey += y
    def duck(self):
        self.rect = self.image.get_rect(y=575, x=125)
    def unduck(self):
        self.rect = self.image.get_rect(y=550, x=125)
...
imageinput = './dinosprites/eddit-original-just-his-head.png'
player = Object()
player.rect.x = 125
player.rect.y = 550
...
enemy = Object()
enemy.rect.x = 1820
enemy.rect.y = 525 + random.randint(-80, 20)
enemy_list = pygame.sprite.Group()
enemy_list.add(enemy)

imageinput = './dinosprites/rsz_rsz_1googleenemy.png'
flyingenemy = Object()
flyingenemy.rect.x = 1820
flyingenemy.rect.y = 525 + random.randint(-80, 20)
